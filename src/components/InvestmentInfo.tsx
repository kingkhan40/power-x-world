    ...
    useEffect(() => {
        const fetchReferral = async () => {
            try {
                ...
                const res = await fetch("/api/user/referrer", {
                    headers: {
                        "x-user-id": userId,
                    },
                });
                ...
                if (!res.ok) {
                    ...
                    // Construct referral link using userId
                    const link = `https://www.powerxworld.uk/register?ref=${userId}`;
            ...
            <div className="w-full mt-3">
                <div className="lg:p-5 p-2 rounded-2xl relative overflow-hidden bg-gray-900/90 shadow-[inset_-5px_-5px_10px_#1f2937,inset_5px_5px_10px_#111827,0px_4px_8px_rgba(0,0,0,0.3)] border border-gray-800">
                    ...
                    <div
                        ...
                        style={{
                            background:
                                "conic-gradient(from 0deg, #ff00ff, #00ffff, #ff00ff, #ffff00)",
