...
const DepositHistory = () => {
  ...
  const tabs: Tab[] = [
    ...
    },
    {
      ...
      label: "Failed",
      icon: <FaTimes />,
      count: depositData.filter((d) => d.confirmed === undefined).length,
    },
  ];
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="flex overflow-x-auto gap-2 mb-6 pb-2 scrollbar-hide">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2 rounded-lg font-semibold transition-all duration-300 ${
                activeTab === tab.id
        ...
        <div className="space-y-4">
          {filteredDeposits.map((deposit) => {
            const dateObj = deposit.createdAt
            ...
            return (
              <div
                key={deposit._id}
                className="p-4 rounded-xl bg-gray-800/60 border border-white/10 backdrop-blur-sm"
              >
