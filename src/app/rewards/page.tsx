...
const Rewards = () => {
  ...
  const handleClaimRewards = () => {
    ...
    // Shishki-mishki effect shuru
    setShowConfetti(true);

    // 3 seconds ke baad success show karo
    setTimeout(() => {
      setIsProcessing(false);
      setIsSuccess(true);

      // 2 seconds ke baad modal close karo
      setTimeout(() => {
        handleCloseModal();
      }, 5000);
    }, 5000);
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {rewardPlans.map((plan) => (
              ...
              >
                ...
                {/* Lock Overlay for Unachieved Rewards */}
                {!plan.achieved && (
      ...
      {/* Premium Modal - Only show for achieved rewards */}
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center lg:p-4 p-2 z-50">
            <div className="w-full max-w-lg bg-gray-900 rounded-2xl border border-white/20 shadow-2xl max-h-[90vh]  animate-slide-up">
              {/* Rotating Border Animation for Modal - WITH OVERFLOW HIDDEN */}
              ...
              <div className="relative z-20 m-1">
                ...
                <div className="p-6 relative z-20">
                  ...
                  {/* Reward Amount Display with Rotating Border - WITH OVERFLOW HIDDEN */}
                  {!isSuccess && (
                  ...
                  {/* Business Requirements with Rotating Borders - WITH OVERFLOW HIDDEN */}
