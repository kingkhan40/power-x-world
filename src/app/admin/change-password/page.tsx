...
const ChangePassword = () => {
  ...
  const getPasswordStrength = (): PasswordStrength => {
    ...
    if (criteriaMet === 5)
      return { strength: "Strong", color: "from-green-500 to-emerald-500", width: "100%" };
    if (criteriaMet >= 3)
      return { strength: "Good", color: "from-blue-500 to-cyan-500", width: "75%" };
    if (criteriaMet >= 2)
      return { strength: "Fair", color: "from-yellow-500 to-orange-500", width: "50%" };
  ...
  return (
    <div
      className="min-h-screen py-2 px-4 relative"
      style={{
        backgroundImage:
